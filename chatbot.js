//Reverse Sentence game
    ...
    //message keywords
    const keywords={
    greetings:["hello","hi","assalamualaikum","assalamuwalaikum","assalamalikum"],
    timeGreetings:["good morning","good afternoon","good evening","good night"],
    asking:["kitha koroin?","kita koro","kita korray","kita koro te okn","kita korray te ar","koi re","kita kortaco","ki koro","ki korcen","ki kortecen","ki korco"],
    ...
    monValaNayKene:["mon vala nay kne","kita oice?","mon vala na kene?","mon vala na kellaigga","mon vala na kere?","ki hoyeche?","mon valo na keno?"],
    tmiValani:["tumi kemon acho?","din kal kemn jay","tmi vala ni","apne vala ni","apni valo achen","tmi valo acho","tmi vala ni?","apni valo achen?","vala acho ni","vala acho ni?","vala ni","bala ni","bala ni?","tumi bala acho ni"],
    kawaDawa:["kawa dawa korchenni?","kawa dawa korco ni","kawa dawa korco ni?","kawa dawa dawa korcoin ni","kawa dawa korcoin ni?","kawa sesh ni","kawa ses ni","kawa sesh ni?","kawa ses ni?","kawa hoice ni?","kawa hoice ni","kaico ni","kaico ni?","kaicen ni","kaicen ni?","kawa dawa korco","kawa dawa koreco","kawa dawa korco?","kawa dawa koreco?","keyecho","keyeco?","kaico","kaico?","vat kaico ni","vat kaico ni?","vat kaicen ni?","bat kaico ni"],
